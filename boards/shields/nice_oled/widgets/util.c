...
void rotate_canvas(lv_obj_t *canvas, lv_color_t cbuf[]) {
  ...
  const uint32_t stride =
      lv_draw_buf_width_to_stride(CANVAS_HEIGHT, LV_COLOR_FORMAT_NATIVE);
  lv_draw_sw_rotate(cbuf_tmp, draw_buf->data, CANVAS_HEIGHT, CANVAS_HEIGHT,
                    stride, stride, LV_DISPLAY_ROTATION_270,
